...
The catalog contains the user's current 111 × 204 cm bed with a 90 × 200 cm mattress, the user's 43 cm front × 57.5 cm deep × 54 cm high bedside cabinet, the existing KESSER minifridge with a 40 × 43 cm footprint and 57 cm height, five estimated new-bed footprints for 90, 120, 140, 160, and 180 cm mattresses, three modular PAX widths, and four VERNAL L-desk contexts. The cabinet drawers pull along the 57.5 cm depth axis; a reserved 35 cm operating strip therefore models an open depth of about 92.5 cm. New-bed footprints assume 8 cm of frame on each mattress side and 9 cm additional total length, based on the previously verified 140 cm reference footprint; these are estimates, not product specifications. In the divider arrangement the cabinet occupies the audited room-corner position `[287,163]` at 144°, next to both 90 cm bed options and outside the bathroom. In the both-rotated arrangement the cabinet instead remains at the single Loggia-wall anchor `[294.8577,163.7061]`; every bed width is derived from that fixed point with a 2 cm planning gap, so changing mattress width never moves the cabinet away from the wall. Configurations where it cannot fit or open remain invalid instead of hiding the cabinet. PAX height is purchase metadata rather than a 2D scenario axis because both available heights have the same footprint. Three bedroom orientation concepts, two independent desk positions, four selectable PAX access reserves, and two minifridge placements produce 3,456 explicit scenarios. The lower desk position is anchored to the reconstructed southeast wall step rather than a fictitious square corner. Each scenario is checked for containment, furniture overlap, crossing to the forbidden bathroom side of interior walls, fixed-kitchen clearance, a 60 × 60 cm desk work zone, mandatory door access, furniture operating zones, at least one usable loggia door, and at least one usable balcony door.
